...
.container{width:1200px; height:420px; overflow:hidden;position:relative; margin:0 auto;}
...
?>
      <li style="background:url(<?php echo $this->_var['flash']['src']; ?>) center 0 no-repeat; position:relative;"><a href="<?php echo $this->_var['flash']['url']; ?>" target="_blank"></a></li>
