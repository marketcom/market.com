...
?>
<dl>
  <dt> <img src="themes/mbyunchaoshi2015/images/left_help_biao.gif"> <a href='<?php echo $this->_var['help_cat']['cat_id']; ?>' title="<?php echo $this->_var['help_cat']['cat_name']; ?>"><?php echo $this->_var['help_cat']['cat_name']; ?></a></dt>
